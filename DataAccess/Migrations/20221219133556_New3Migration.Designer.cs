...
namespace DataAccess.Migrations
{
    ...
    [Migration("20221219133556_New3Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Concrete.User", b =>
                {
                    ...
                    b.Property<int>("LatestRefreshTokenId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LatestRefreshTokenId");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.User", b =>
                {
                    b.HasOne("Core.Utilities.Security.JWT.RefreshToken", "LatestRefreshToken")
                        .WithMany()
                        .HasForeignKey("LatestRefreshTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LatestRefreshToken");
                });
